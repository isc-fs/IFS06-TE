def writedatatxt(bucketnever,piloto,circuito):
    '''
    Esta función esta diseñada para leer datos de un archivo de texto y escribirlos en una base de datos InfluxDB. 
    Los datos son de varios sensores del coche. 
    La función también parece tener la capacidad de terminar su ejecución cuando se presiona la tecla "shift derecho".
...
def writedatatxtsints(bucketnever,bucket,piloto,circuito):
    '''
    Esta función hace algo similar a writedatatxt, 
    pero está diseñada para trabajar en un sistema Linux y leer de un archivo de texto diferente.
    '''
...
def rxnrf24(bucketnever,piloto,circuito):
    '''
    Esta función esta diseñada para recibir datos de un dispositivo NRF24 
    (un módulo de radio de baja potencia) y escribir esos datos en una base de datos InfluxDB. 
    Los datos vienen de varios sensores del coche.
