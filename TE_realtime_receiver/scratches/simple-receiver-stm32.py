...
if __name__ == "__main__":
    ...
    TxAddress = bytearray([0xEE, 0xDD, 0xCC, 0xBB, 0xAA])
    ...
    parser.add_argument('address', type=str, nargs='?', default=TxAddress, help="Address to listen to (3 to 5 ASCII characters)")
    ...
    nrf = NRF24(pi, ce=25, payload_size=RF24_PAYLOAD.DYNAMIC, channel=100, data_rate=RF24_DATA_RATE.RATE_1MBPS, pa_level=RF24_PA.MIN)
    # pongo data rate a 1Mbps porque en el datasheet solo da a elegir entre 1 y 2 Mbps aunque siempre hemos funcionado en 256Kbps
